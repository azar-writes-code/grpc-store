...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=idk.Keyboard_Layout" json:"layout,omitempty"`
...
var file_proto_keyboard_message_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x6b, 0x22, 0x8d, 0x01, 0x0a, 0x08, 0x4b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64,
	0x12, 0x2c, 0x0a, 0x06, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x14, 0x2e, 0x69, 0x64, 0x6b, 0x2e, 0x4b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e,
...
var file_proto_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: idk.Keyboard.Layout
	(*Keyboard)(nil),     // 1: idk.Keyboard
}
var file_proto_keyboard_message_proto_depIdxs = []int32{
	0, // 0: idk.Keyboard.layout:type_name -> idk.Keyboard.Layout
